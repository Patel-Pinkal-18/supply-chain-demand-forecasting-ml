...
📌 *Note: Download the dataset and place it inside the `data/` folder before running the notebook.*
...
### 📈 Model Performance Comparison 
  ![model_performance](screenshots/model_performance.png)

---  
  
### 📉 Shipping cost analysis 
   ![Ship_cost_analysis](screenshots/shipping_cost.png)

---   

### 📊 Supplier performance comparison → *Supplier_analysis*  
